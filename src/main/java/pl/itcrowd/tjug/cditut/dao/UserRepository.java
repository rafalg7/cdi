...
public class UserRepository implements Serializable {
    ...
    public User getUserByName(String name) {
        final List<User> resultList = (List<User>) em.createQuery(
                "SELECT u FROM User u WHERE u.name LIKE :sName").setParameter("sName", name).getResultList();
    ...
    public void save(@Observes @Saved User user) {
        saveUser(user);
    }
